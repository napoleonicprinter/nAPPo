...
export const AppProvider = ({ children }) => {
  ...
  const deviceMode = import.meta.env.MODE;
  const battleUnitsEnabled = import.meta.env.VITE_ENABLE_BATTLE_UNITS === 'true';
  
  // Apply body class based on device mode for responsive styling
  useEffect(() => {
    ...
    // New state for preview device selection (mobile, tablet, desktop)
